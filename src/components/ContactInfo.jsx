    ...
    <div className="space-y-8">
      ...
      <div className="bg-zinc-950 border border-zinc-900 rounded-xl p-6 lg:p-8">
        ...
        <div className="text-center">
          <p className="text-gray-300 mb-4">
            I'm always excited to collaborate on Web3, DeFi, or full-stack
            projects. Whether it's a groundbreaking dApp or a scalable web
            application, let's create something extraordinary together!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg transition-colors duration-200"
            >
      ...
      <div className="bg-gradient-to-r from-green-600/10 to-blue-600/10 border border-green-600/20 rounded-xl p-6">
        ...
        <p className="text-gray-300 text-sm leading-relaxed">
          I'm actively seeking new opportunities in Web3 development, smart
          contract auditing, and full-stack projects. Open to both freelance
          work and full-time positions. Let's discuss how we can work together!
        </p>
      </div>
    </div>
  );
