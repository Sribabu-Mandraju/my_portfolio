...
export default function Sidebar({ isMobileMenuOpen, setIsMobileMenuOpen }) {
  return (
    <nav
      className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-black border-r border-zinc-900 transform ${
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="p-6 text-center border-b border-zinc-900">
          <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden bg-zinc-950">
            <img
              src={profileImg}
              alt="sribabu Avatar"
